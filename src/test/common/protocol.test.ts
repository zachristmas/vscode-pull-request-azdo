...
const testRemote = (remote: {
	...
	describe(`new Protocol(${str(remote.uri)})`, () => {
		let protocol: Protocol;
		before(() => (protocol = new Protocol(remote.uri)));

		it(`type should be ${ProtocolType[remote.expectedType]}`, () => assert.equal(protocol.type, remote.expectedType));
...
describe('Protocol', () => {
	describe('with HTTP and HTTPS remotes', () =>
		[
			{
				uri: 'http://rmacfarlane@github.com/Microsoft/vscode',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			},
			{
				uri: 'http://rmacfarlane:password@github.com/Microsoft/vscode',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'http://rmacfarlane:password@www.github.com/Microsoft/vscode',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'http://github.com/Microsoft/vscode',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'http://github.com/Microsoft/vscode.git',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'http://www.github.com/Microsoft/vscode.git',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'http://github.com:433/Microsoft/vscode.git',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'https://rmacfarlane@github.com/Microsoft/vscode',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'https://rmacfarlane:password@github.com/Microsoft/vscode',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'https://github.com:433/Microsoft/vscode.git',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'https://www.github.com:433/Microsoft/vscode.git',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'https://github.enterprise.corp/Microsoft/vscode.git',
				expectedType: ProtocolType.HTTP,
				expectedHost: 'github.enterprise.corp',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			},
		].forEach(testRemote));
	...
	it('should handle SSH remotes', () =>
		[
			...
			{
				uri: 'ssh://github.com:Microsoft/vscode.git',
				expectedType: ProtocolType.SSH,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'ssh://git@github.com:433/Microsoft/vscode',
				expectedType: ProtocolType.SSH,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'ssh://user@git.server.org:project.git',
				expectedType: ProtocolType.SSH,
				expectedHost: 'git.server.org',
				expectedOwner: '',
	...
	it('should handle SCP-like remotes', () =>
		[
			{
				uri: 'git@github.com:Microsoft/vscode',
				expectedType: ProtocolType.SSH,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'git@github.com:Microsoft/vscode.git',
				expectedType: ProtocolType.SSH,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'github.com:Microsoft/vscode.git',
				expectedType: ProtocolType.SSH,
				expectedHost: 'github.com',
				expectedOwner: 'Microsoft',
				expectedRepositoryName: 'vscode',
			...
			{
				uri: 'user@git.server.org:project.git',
				expectedType: ProtocolType.SSH,
				expectedHost: 'git.server.org',
				expectedOwner: '',
				expectedRepositoryName: 'project',
			...
			{
				uri: 'git.server2.org:project.git',
				expectedType: ProtocolType.SSH,
				expectedHost: 'git.server2.org',
				expectedOwner: '',
				expectedRepositoryName: 'project',
			},
		].forEach(testRemote));
	...
	it('should handle local remotes', () =>
		[
			{
				uri: '/opt/git/project.git',
				expectedType: ProtocolType.Local,
				expectedHost: '',
				expectedOwner: '',
				expectedRepositoryName: '',
			},
			{
				uri: 'file:///opt/git/project.git',
				expectedType: ProtocolType.Local,
				expectedHost: '',
				expectedOwner: '',
				expectedRepositoryName: '',
	...
	describe('Protocol.update when changing protocol type to SSH', () =>
		[
			{
				uri: 'http://rmacfarlane@github.com/Microsoft/vscode',
				change: { type: ProtocolType.SSH },
				expected: 'git@github.com:Microsoft/vscode',
			},
			{
				uri: 'http://rmacfarlane:password@github.com/Microsoft/vscode',
				change: { type: ProtocolType.SSH },
			...
			},
			{
				uri: 'https://github.enterprise.corp/Microsoft/vscode.git',
				change: { type: ProtocolType.SSH },
				expected: 'git@github.enterprise.corp:Microsoft/vscode',
			},
		].forEach(remote =>
	...
	describe('with a ~/.ssh/config', () => {
		before(() => (ssh.Resolvers.current = ssh.Resolvers.fromConfig(SSH_CONFIG_WITH_HOST_ALIASES)));
		after(() => (ssh.Resolvers.current = ssh.Resolvers.default));
